...
namespace Cap24Team3.Areas.Faculty.Controllers
{
    ...
    public class AspNetUserFacultysController : Controller
    {
        ...
        // GET: Faculty/AspNetUserFacultys
        public ActionResult Index()
        {
            return View(db.AspNetUsers.ToList());
        }

        // GET: Faculty/AspNetUserFacultys/Details/5
        ...
        // GET: Faculty/AspNetUserFacultys/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Faculty/AspNetUserFacultys/Create
        ...
        // GET: Faculty/AspNetUserFacultys/Edit/5
        ...
        // POST: Faculty/AspNetUserFacultys/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: Faculty/AspNetUserFacultys/Delete/5
        ...
        // POST: Faculty/AspNetUserFacultys/Delete/5
